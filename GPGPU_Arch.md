...
<img src=".\Image\Fig3.12.jpg" align="left"  alt="Fig3.12" style="zoom: 40%;" />
...
<img src=".\Image\Fig3.13.jpg" align="left"  alt="Fig3.12" style="zoom: 60%;" />
...
<img src=".\Image\Fig3.14.jpg" align="left"  alt="Fig3.12" style="zoom: 60%;" />
...
<img src=".\Image\Fig3.15.png" align="left"  alt="Fig3.12" style="zoom: 50%;" />
...
<img src=".\Image\Fig3.16.png" align="left"  alt="Fig3.16" style="zoom: 50%;" />
...
<img src=".\Image\Fig3.17.png" align="left"  alt="Fig3.17" style="zoom: 50%;" />
...
​	GPU流水线的结构性危害潜在原因很多。例如，寄存器读取阶段可能用完操作数收集器单元。许多结构危害的来源与内存系统有关，我们将在下一章更详细地讨论。一般来说，由 warp 执行的单个内存指令可能需要分解为多个独立的操作。这些独立操作中的每一个都可以在给定的周期内充分利用流水线的一部分。

​	指令在GPU流水线中遇到结构危害会怎样？在单线程有序CPU流水线中，标准解决方案是暂停较新的指令，直到遇到暂停情况的指令能够取得进一步的进展。这种方法在吞吐量大的多线程架构中不太理想，至少有两个原因。首先，给定寄存器堆的大尺寸以及支持完整图形流水线所需的许多流水线级，分发停滞信号可能会影响关键路径。流水线停顿周期分布导致需要引入额外的缓冲增加面积。其次，停止一个扭曲的指令可能会导致其他扭曲的指令停止运行。如果指令失败，吞吐量可能会受到影响。
